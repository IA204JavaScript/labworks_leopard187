...
## 2. Автор проекта.
Автором данного проекта является студент *Леонид (@leopard) Пармакли*. Он является большим любителем языка С++ и компьютерной графики. Любит поиграть в игры. Не любит веб-программирование, но относится к нему уважением. **Ненавидит компьютерные сети.**
